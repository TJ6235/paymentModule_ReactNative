...
const Selftransfersuccess = (props) => {
...
<TouchableOpacity style={styles.closebuttoncontainer} onPress={()=>{props.navigation.navigate('paymenttoselfaccount')}} >
<View>
...
export default Selftransfersuccess
