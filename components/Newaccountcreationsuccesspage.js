...
const Newaccountcreationsuccesspage = (props) => {
...
<View style={{alignItems:'center'}}>
    <Text style={{marginTop:10}}>  Account Created Successfully .</Text>
</View>
<TouchableOpacity style={styles.closebuttoncontainer} onPress={()=>{props.navigation.navigate('paymenttoaccountnumber')}} >
<View>
...
export default Newaccountcreationsuccesspage
