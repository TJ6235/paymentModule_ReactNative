...
const Newmmidcreationsuccess = (props) => {
...
<View style={{alignItems:'center'}}>
    <Text style={{marginTop:10}}> Successfully Created MMID.</Text>
</View>
<TouchableOpacity style={styles.closebuttoncontainer} onPress={()=>{props.navigation.navigate('paymenttommid')}} >
<View>
...
export default Newmmidcreationsuccess
