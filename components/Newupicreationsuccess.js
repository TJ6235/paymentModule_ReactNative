...
const Newupicreationsuccess = (props) => {
...
<View style={{alignItems:'center'}}>
    <Text style={{marginTop:10}}>  UPI ID Created Successfully .</Text>
</View>
<TouchableOpacity style={styles.closebuttoncontainer} onPress={()=>{props.navigation.navigate('paymenttoupiid')}} >
<View>
...
export default Newupicreationsuccess
